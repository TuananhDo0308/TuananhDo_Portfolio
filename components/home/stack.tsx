          ...
          >
            <div className="relative">
              <h2 className="text-2xl md:text-3xl lg:text-5xl font-medium">
                Focus{" "}
                <ArrowDownRight className="inline w-6 h-6 md:w-8 md:h-8" />
              </h2>
            </div>
            <motion.p
              initial={{ opacity: 0 }}
              ...
              {stacks.map((stack, index) => {
                return (
                  ...
                  >
                    <Link
                      href={stack.href}
                      className="text-2xl md:text-4xl lg:text-5xl font-bold text-white group-hover:text-neutral-300 transition-colors duration-300"
                    >
                      {stack.name}
                    </Link>
                  </motion.div>
