          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-gray-400 text-lg leading-relaxed mb-6">
                ...
                performant, and accessible web experiences. With expertise in
                modern frameworks like React, TypeScript, and Tailwind CSS, I
                transform designs into functional, user-centric digital
                products.
              </p>
              <p className="text-gray-400 text-lg leading-relaxed">
                I believe great code is clean, maintainable, and brings joy to
                both users and developers. When I'm not coding, you can find me
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div
                  key={skill.label}
                  className="p-6 rounded-xl bg-gradient-to-br from-purple-500/10 to-blue-500/10 border border-purple-400/20 hover:border-purple-400/50 transition-all duration-300"
                >
            ...
            {[
              {
                ...
                desc: "Full-stack e-commerce solution with React, Node.js, and PostgreSQL",
              },
              {
              ...
              <div
                key={i}
                className="group p-8 rounded-xl bg-gradient-to-br from-purple-500/5 to-blue-500/5 border border-purple-400/20 hover:border-purple-400/50 transition-all duration-300 cursor-pointer hover:shadow-lg hover:shadow-purple-500/10"
              >
      ...
      <section className="relative w-full py-24 px-8 bg-black border-t border-white/5">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-gray-400 text-lg mb-12 max-w-2xl mx-auto">
            ...
            out. I'm always excited to collaborate and create amazing digital
            experiences.
          </p>
